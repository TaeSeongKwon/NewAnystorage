 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> ,MyObserver{
    @Override
    public void doRun(JSONObject obj) {
        try {
            ...
            if(type.equals(Resource.RESPONSE_LOGIN)) {
                ...
                if(code == Resource.SUCCESS) isLogin = true;
                else isLogin = false;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                Log.e("===== User Info =====", " ");
                Log.e("user_id ", mEmail);
                Log.e("user_pwd ", mPassword);
                Log.e("=====================", " ");

                JSONObject obj = new JSONObject();
                obj.put("type", Resource.REQUEST_LOGIN);
                obj.put("user_id", mEmail);
                obj.put("user_pwd", mPassword);
...
//            return true;
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                SharedPreferences preferences = LoginActivity.this.getSharedPreferences("account", MODE_PRIVATE);
                SharedPreferences.Editor edit = preferences.edit();
                edit.putString("user_id", mEmail);
                edit.putString("user_pwd", mPassword);
                edit.commit();
                Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                startActivity(intent);

                comm.removeObserver(LoginActivity.this);
